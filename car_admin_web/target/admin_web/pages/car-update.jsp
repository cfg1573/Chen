				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="carName" value="${car.carName}"
								   readonly="readonly">
						</div>
						...
						<div class="col-md-4 data">
							<div class="input-group date">
								...
								<input type="text" class="form-control pull-right"
									   id="datepicker-a6" name="cerifacteTime" value="${car.cerifaceTimeStr}"readonly="readonly">
							</div>
						</div>
						...
						<div class="col-md-10 data">
							<select class="form-control select2" style="width: 100%"
									name="carStraus" value="${car.carStraus}">
								<option value="0">车辆等待</option>
								<option value="1" selected="selected">车辆出行</option>
							</select>
						</div>
